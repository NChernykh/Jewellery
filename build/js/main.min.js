...
/* harmony import */ var _modules_init_form__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/init-form */ "./js/modules/init-form.js");
/* harmony import */ var _modules_init_burger__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/init-burger */ "./js/modules/init-burger.js");
...
Object(_modules_init_form__WEBPACK_IMPORTED_MODULE_3__["initForm"])();
Object(_modules_init_burger__WEBPACK_IMPORTED_MODULE_4__["initBurger"])();
Object(_modules_init_swiper__WEBPACK_IMPORTED_MODULE_5__["initSwiper"])();
Object(_modules_init_accordion__WEBPACK_IMPORTED_MODULE_6__["initAccordion"])();
...
var trigger = document.querySelectorAll('.accordion__trigger');
var toggle = document.querySelectorAll('.accordion__toggle');
var parentElem = document.querySelector('.accordion');
    ...
    parentElem.addEventListener('click', function (event) {
      ...
      if (target && target.classList.contains('accordion__trigger')) {
        ...
        trigger.forEach(function (item, i) {
          var itemShow = getItem(trigger, 'accordion__trigger--show');
      ...
      if (target && target.classList.contains('accordion__toggle')) {
        toggle.forEach(function (item) {
          var itemToggle = getItem(toggle, 'accordion__toggle');
...
var modal = document.querySelector('.login__form');
var modalMail = modal.querySelector('[name=email]');
...
var modalAddBtns = document.querySelectorAll('[data-modal="add"]');
var modalLogin = document.querySelector('.modal--login');
var modalLoginBtns = document.querySelectorAll('[data-modal="login"]');
var inputFocus = document.querySelector('[data-mail]'); // аргументы setupModal(modal, closeCallback, modalBtns, openCallback, noPrevDefault, preventScrollLock)
...
var initModals = function initModals() {
  ...
  if (modalAdd && modalAddBtns.length) {
    Object(_utils_modal__WEBPACK_IMPORTED_MODULE_0__["setupModal"])(modalAdd, false, modalAddBtns, false, false);
  }

  if (modalLogin && modalLoginBtns.length) {
    Object(_utils_modal__WEBPACK_IMPORTED_MODULE_0__["setupModal"])(modalLogin, false, modalLoginBtns, false, false, false, inputFocus);
  }
};
...
var initSwiper = function initSwiper() {
  ...
  swiper.on('resize', function () {
    if (window.screen.width >= 1024) {
      ...
      document.querySelectorAll('.slider__nav').forEach(function (item) {
  ...
  swiper.on('slideChange', function () {
    var allSlides = document.querySelector('.slider__total');
    var currentSlides = document.querySelector('.slider__current');
    var length = swiper.slides.length;
    allSlides.innerHTML = length / 2;
    var current = (++swiper.realIndex + 1) / 2;
